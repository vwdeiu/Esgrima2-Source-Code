package Esgrima2_fla
{
   ...
   public dynamic class warlock2_FireStorm_1380 extends MovieClip
   {
      ...
      public function warlock2_FireStorm_1380()
      {
      ...
      function frame1() : *
      {
         ...
         if(_loc1_)
         {
            this.synchronize = Vector.<String>(["fire","wave"]);
         }
      }
   }
}
